const AetherRecipes = (event) => {
  ...
  //TFC Heating
  event.recipes.tfc.heating("aether:iron_gloves", 1535).resultFluid(Fluid.of("tfc:metal/cast_iron", 200));

  event.recipes.tfc.heating("aether:iron_pendant", 1535).resultFluid(Fluid.of("tfc:metal/cast_iron", 100));

  event.recipes.tfc.heating("aether:iron_ring", 1535).resultFluid(Fluid.of("tfc:metal/cast_iron", 50));

  event.recipes.tfc.heating("aether:golden_gloves", 1060).resultFluid(Fluid.of("tfc:metal/gold", 200));

  event.recipes.tfc.heating("aether:golden_pendant", 1060).resultFluid(Fluid.of("tfc:metal/gold", 100));

  event.recipes.tfc.heating("aether:golden_ring", 1060).resultFluid(Fluid.of("tfc:metal/gold", 50));

  //TFC Smithing
  event.recipes.tfc
    .anvil("aether:iron_gloves", "tfc:metal/sheet/wrought_iron", ["draw_not_last", "bend_any", "bend_any"])
    .bonus(true)
    .tier(3)
    .id("twt:anvil/iron_gloves");

  event.recipes.tfc
    .anvil("aether:golden_gloves", "tfc:metal/sheet/gold", ["draw_not_last", "bend_any", "bend_any"])
    .bonus(true)
    .tier(1)
    .id("twt:anvil/golden_gloves");

  event.recipes.tfc
    .anvil("aether:golden_ring", "tfc:metal/rod/gold", ["draw_not_last", "bend_any", "bend_any"])
    .bonus(true)
    .tier(1)
    .id("twt:anvil/golden_ring");

  event.recipes.tfc
    .anvil("aether:iron_ring", "tfc:metal/rod/wrought_iron", ["draw_not_last", "bend_any", "bend_any"])
    .bonus(true)
    .tier(3)
    .id("twt:anvil/iron_ring");

  //TFC knapping
  event.recipes.tfc
    .knapping("aether:leather_gloves", "tfc:leather", ["XXXXX", "XXXXX", "XXXXX", "XXXXX", " XXX "])
