...
const IronchestRecipes = (event) => {
  ...
  function ironchestsinputswap(currentinput, inputswap) {
    event.replaceInput({ mod: "ironchests" }, currentinput, inputswap);
  }
  ...
  //smithing
  event.recipes.tfc.anvil("ironchests:iron_dolly", "tfc:metal/double_sheet/wrought_iron", [
    "bend_any",
    "hit_any",
    "hit_any",
  ]);
  event.recipes.tfc.anvil("ironchests:key", "tfc:metal/rod/wrought_iron", [
    "shrink_any",
    "bend_any",
    "punch_last",
  ]);
  event.recipes.tfc.anvil("ironchests:key_ring", "tfc:metal/rod/wrought_iron", [
    "bend_any",
    "bend_any",
    "bend_any",
  ]);
  event.recipes.tfc.anvil("ironchests:lock", "tfc:metal/ingot/gold", [
    "shrink_not_last",
    "hit_any",
    "punch_last",
  ]);
  ...
  //TFC heating
  event.recipes.tfc
    .heating("ironchests:key", 1535)
    .resultFluid(Fluid.of("tfc:metal/cast_iron", 50));
  event.recipes.tfc
    .heating("ironchests:key_ring", 1535)
    .resultFluid(Fluid.of("tfc:metal/cast_iron", 50));
  event.recipes.tfc.heating("ironchests:lock", 1060).resultFluid(Fluid.of("tfc:metal/gold", 100));
  event.recipes.tfc
    .heating("ironchests:iron_dolly", 1535)
    .resultFluid(Fluid.of("tfc:metal/cast_iron", 400))
    .useDurability(true);

  //shaped
  event.recipes.kubejs.shaped("ironchests:diamond_dolly", [" X ", "XDX", " X "], {
